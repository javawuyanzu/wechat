...
Page({
  ...
  onShow: function (options) {
    ...
    wx.request({
      //获取openid接口   
      url: 'https://apis.sdcsoft.com.cn/webapi/boilermanage/productcategory/pagelist',
      data: {
        total: 100, pageNum: 1, pageSize: 100, orgId: app.globalData.customer.orgId,
      },
      method: 'get',
        ...
        if (res.tapIndex == 1) {
          wx.showModal({
            ...
            success: function (sm) {
              if (sm.confirm) {
                wx.request({
                  url: 'https://apis.sdcsoft.com.cn/webapi/boilermanage/productcategory/deleteboilermodelbyid',
                  header: {

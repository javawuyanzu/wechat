...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      //获取openid接口   
      url: 'https://apis.sdcsoft.com.cn/webapi/boilermanage/partcategory/list',
      ...
      success: function (res) {
        ...
        if (that.data.title == "编辑") {
          ...
          wx.request({
            //获取openid接口   
            url: 'https://apis.sdcsoft.com.cn/webapi/boilermanage/partsubcategory/list',
            data: {
  ...
  quenyButton1: function () {
    ...
    if (that.data.title == "编辑") {
      wx.request({
        //获取openid接口   
        url: 'https://apis.sdcsoft.com.cn/webapi/boilermanage/productpartinfo/modify',

...
Page({
        ...
        wx.request({
          ...
          success: function (res) {
            if (res.data.byteLength == 0) {
              ...
              let data = app.globalData.deviceAdapter.getSdcSoftDevice(app.globalData.lang,deviceType, new Uint8Array(res.data))
              var errorList = []
  ...
  //         }
  //       }
  //       let data = app.globalData.deviceAdapter.getSdcSoftDevice(deviceType, new Uint8Array(byte), app.globalData.lang)
  ...
  //         }
  //         for (var index in data.getMockFields().map) {
  //           if (data.getMockFields().map[index].name === "mo_qidongjiarezushu") {
  //             jiarezu1 = data.getMockFields().map[index].valueString
  //           }
  //           if (mock11 === "") {
  //             mock11 = data.getMockFields().map[index].title + ":" + data.getMockFields().map[index].valueString
  //             continue;
  ...
  //         }
  //       }
  //       ilist.push({ title: title1, runstate: runstate1, deviceNo: deviceNo, imgstyle: imgstyle1, errcount: errcount1, src: src1, mock1: mock11, mock2: mock22, runday: day + hour, type: deviceType })
  //       that.setData({
  //         imgList: ilist
  //       })
  //     }

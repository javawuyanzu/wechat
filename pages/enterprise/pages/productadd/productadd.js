...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      //获取openid接口   
      url: 'https://apis.sdcsoft.com.cn/webapi/enterprise/productcategory/list',
      method: 'get',
      success: function (res) {
        ...
        wx.request({
          //获取openid接口   
          url: 'https://apis.sdcsoft.com.cn/webapi/enterprise/product/search?pageNum=1&pageSize=100',
    ...
    wx.request({
      //获取openid接口   
      url: 'https://apis.sdcsoft.com.cn/webapi/enterprise/dictionaryvalue/list',
      data: {
        type: "fuel"
      },
      method: 'get',
  ...
  quenyButton1:function(){
    ...
    wx.request({
      //获取openid接口   
      url:  'https://apis.sdcsoft.com.cn/webapi/enterprise/product/search?pageNum=1&pageSize=5',
                data:  {
                  boilerNo: "",
      ...
      success: function (data) {
        ...
        if(that.data.title=="编辑"){
          ...
          wx.request({
            //获取openid接口   
            url: 'https://apis.sdcsoft.com.cn/webapi/enterprise/product/modify',
            data: that.data.product,
            method: 'post',
            success: function (data) {
              wx.navigateBack({
          ...
          if(arr.length==0){
            ...
            wx.request({
              //获取openid接口   
              url: 'https://apis.sdcsoft.com.cn/webapi/enterprise/product/create',
              data: that.data.product,
              method: 'post',
              success: function (data) {
                wx.navigateBack({

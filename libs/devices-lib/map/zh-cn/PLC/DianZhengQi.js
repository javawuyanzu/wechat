...
module.exports = /** @class */ (function (_super) {
    ...
    function Map_PLC_DianZhengQi() {
        ...
        _this.addPoint(new meta_1.BaseInfoField('ba_shuiweizhuangtai', 19, 2, '水位状态', '', Map_PLC_DianZhengQi.coms_level));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_HuiLiuWenDu, 63, 4, '进水温度', '℃'));
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_QianYa, 233, 2, '欠压报警', 5, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField('ex_shuiweiweidibaojing_dianji', 233, 2, '水位危低报警（电极）', 8, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（电极）', 9, meta_1.ExceptionField.Exception_Error), 'ex_shuiweijidibaojing_dianji');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianGaoShuiWei, 233, 2, '水位极高报警（电极）', 10), 'ex_shuiweijigaobaojing_dianji');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（设定值）', 11, meta_1.ExceptionField.Exception_Error), 'ex_shuiweijidibaojing_shedingzhi');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianGaoShuiWei, 233, 2, '水位极高报警（设定值）', 12), 'ex_shuiweijigaobaojing_shedingzhi');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '超压报警（压力开关）', 13, meta_1.ExceptionField.Exception_Error), 'ex_chaoyabaojing_yalikaiguan');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '超压报警（设定值）', 14, meta_1.ExceptionField.Exception_Error), 'ex_chaoyabaojing_shedingzhi');

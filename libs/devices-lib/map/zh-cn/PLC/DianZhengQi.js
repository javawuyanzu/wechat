...
module.exports = /** @class */ (function (_super) {
    ...
    function Map_PLC_DianZhengQi() {
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（电极）', 9), 'ex_shuiweijidibaojing_dianji');
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（设定值）', 11), 'ex_shuiweijidibaojing_shedingzhi');
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '超压报警（压力开关）', 13), 'ex_chaoyabaojing_yalikaiguan');
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '超压报警（设定值）', 14), 'ex_chaoyabaojing_shedingzhi');

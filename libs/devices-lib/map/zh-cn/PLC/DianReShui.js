...
module.exports = /** @class */ (function (_super) {
    ...
    function Map_PLC_DianReShui() {
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 233, 2, '水位极低报警（电极）', 8));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '系统超压报警（设定值）', 9), 'ex_xitongchaoyabaojing（shedingzhi');
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 233, 2, '系统超压报警（电接点压力表）', 11), 'ex_xitongchaoyabaojing（dianjiedianyalibiao）');
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_LuBiChaoWen, 233, 2, '炉壁超温报警', 1));

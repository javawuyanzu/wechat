...
module.exports = /** @class */ (function (_super) {
    ...
    function Map_PLC_RanYouReShui() {
        ...
        _this.addPoint(new meta_1.BaseInfoField('ba_shuiweizhuangtai', 19, 2, '水位状态', '', Map_PLC_RanYouReShui.coms_level));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_PaiYanWenDu, 43, 4, '排烟温度', '℃'));
        ...
        _this.addPoint(new meta_1.SettingField('se_qiluwendusheding', 248, 4, '启炉温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0078', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_mubiaowendusheding', 252, 4, '目标温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007A', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_tingluwendusheding', 256, 4, '停炉温度设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007C', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_yalidisheding', 260, 4, '压力低设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '007E', 0, 2.5));
        _this.addPoint(new meta_1.SettingField('se_yaligaosheding', 264, 4, '压力高设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0080', 0, 2.5));
        _this.addPoint(new meta_1.SettingField('se_paiyanwenduchaogaobaojingsheding', 268, 4, '排烟温度超高报警设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0082', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_chukouwenduchaogaobaojingsheding', 272, 4, '出口温度超高报警设定', '℃', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0084', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_yalichaogaobaojingsheding', 276, 4, '压力超高报警设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0086', 0, 2.5));
        _this.addPoint(new meta_1.SettingField('se_yalichaodibaojingsheding', 280, 4, '压力超低报警设定', 'Mpa', 0, Map_PLC_RanYouReShui.Commands_Key_Parameters_Setting, '0088', 0, 2.5));
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_LuBiChaoWen, 448, 2, '炉壁超温报警', 0, meta_1.ExceptionField.Exception_Error));
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_WaiBuLianSuoDuanKai, 448, 2, '外部连锁断开报警', 6));
        _this.addPoint(new meta_1.ExceptionField('ex_chushuiyalibiansongqiguzhang', 448, 2, '出水压力变送器故障', 7));
        _this.addPoint(new meta_1.ExceptionField('ex_ranshaojiguzhang', 448, 2, '燃烧器故障', 8, meta_1.ExceptionField.Exception_Error));
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 448, 2, '压力超高报警', 11, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_DiYa, 448, 2, '压力超低报警', 12));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_PaiYanWenDuChaoGao, 448, 2, '排烟温度超高报警', 13, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChuKouWenDuChaoGao, 448, 2, '出水温度超高报警', 14, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField('ex_queshuibaohubaojing', 448, 2, '缺水保护报警', 15, meta_1.ExceptionField.Exception_Error));

...
module.exports = /** @class */ (function (_super) {
    ...
    function Map_PLC_RanYouZhenKong() {
        ...
        _this.addPoint(new meta_1.BaseInfoField('ba_shuiweizhuangtai', 19, 2, '水位状态', '', Map_PLC_RanYouZhenKong.coms_level));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_ReShuiYaLi, 39, 4, '真空压力', 'Kpa'));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_CaiNuanChuKouWenDu, 55, 4, '采暖出水温度', '℃'));
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_CaiNuanHuiLiuWenDu, 59, 4, '采暖回水温度', '℃'));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_ShengHuoChuKouWenDu, 71, 4, '生活出水温度', '℃'));
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_ShengHuoHuiLiuWenDu, 75, 4, '生活回水温度', '℃'));
        ...
        _this.addPoint(new meta_1.SettingField('se_qiluwendusheding', 111, 4, '启炉温度设定', '℃', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '0036', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_mubiaowendusheding', 115, 4, '目标温度设定', '℃', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '0038', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_tingluwendusheding', 119, 4, '停炉温度设定', '℃', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '003A', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_zhenkongyalidisheding', 123, 4, '真空压力低设定', 'KPa', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '003C', 0, 2.5));
        _this.addPoint(new meta_1.SettingField('se_zhenkongyaligaosheding', 127, 4, '真空压力高设定', 'KPa', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '003E', 0, 2.5));
        _this.addPoint(new meta_1.SettingField('se_paiyanwenduchaogaobaojingsheding', 131, 4, '排烟温度超高报警设定', '℃', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '0040', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_chukouwenduchaogaobaojingsheding', 135, 4, '出口温度超高报警设定', '℃', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '0042', 0, 400));
        _this.addPoint(new meta_1.SettingField('se_zhenkongyalichaogaobaojingsheding', 139, 4, '真空压力超高报警设定', 'KPa', 0, Map_PLC_RanYouZhenKong.Commands_Key_Parameters_Setting, '0044', 0, 2.5));

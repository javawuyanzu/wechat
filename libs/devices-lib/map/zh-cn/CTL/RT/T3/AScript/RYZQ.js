...
var Map_CTL_RT_T3_RYZQ_Ts = /** @class */ (function (_super) {
    ...
    function Map_CTL_RT_T3_RYZQ_Ts() {
        ...
        _this.addPoint(new meta_1.ExceptionField("ex_shuiweichuanganqiduanlu", 45, 2, "水位传感器短路", 4, meta_1.ExceptionField.Exception_Error));
        ...
        _this.addPoint(new meta_1.ExceptionField("ex_jixiandishuiweibaojing", 45, 2, "极限低水位报警", 8, meta_1.ExceptionField.Exception_Error));
        ...
        _this.addPoint(new meta_1.ExceptionField("ex_gaoshuiweibaojing", 45, 2, "高水位报警", 11, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_bianpinqiguzhang", 45, 2, "变频器故障", 12));
        _this.addPoint(new meta_1.ExceptionField("ex_chaoyabaojing_kongzhiqi_", 45, 2, "超压报警（控制器）", 13, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_ranqiyalidibaojing", 45, 2, "燃气压力低报警", 14, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_ranqiyaligaobaojing", 45, 2, "燃气压力高报警", 15, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_ranqixieloubaojing", 47, 2, "燃气泄漏报警", 0, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_ranshaoqiguzhang", 47, 2, "燃烧器故障", 1, meta_1.ExceptionField.Exception_Error));
        return _this;
    }

...
module.exports = (_a = /** @class */ (function (_super) {
        ...
        function Map_CTL_RT_H1_RYRS() {
            ...
            _this.addPoint(new meta_1.ExceptionField('ex_zhengqiyalibiansongqiduanlu', 45, 2, '蒸汽压力变送器短路', 2, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_chaoyabaojing_biansongqi_', 45, 2, '超压报警（变送器）', 3, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_paiyanwendugaobaojing', 45, 2, '排烟温度高报警', 4, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_chaoyabaojing_kongzhiqi_', 45, 2, '超压报警（控制器）', 5, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_ranshaoqiguzhang', 45, 2, '燃烧器故障', 6, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_ranqiyalidi', 45, 2, '燃气压力低', 7, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_RanQiXieLou, 45, 2, '燃气泄漏报警', 8, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField('ex_shuiweidianjiluojicuo', 45, 2, '水位电极逻辑错', 9));
            _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianGaoShuiWei, 45, 2, '高水位报警', 10, meta_1.ExceptionField.Exception_Error));
            ...
            _this.addPoint(new meta_1.ExceptionField('ex_shuiweichuanganqiduanlu', 45, 2, '水位传感器短路', 15, meta_1.ExceptionField.Exception_Error));

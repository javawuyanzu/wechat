...
module.exports = (_a = /** @class */ (function (_super) {
        ...
        function Map_CTL_RT_H1_RYRS() {
            ...
            _this.addPoint(new meta_1.ExceptionField("ex_jixiandishuiweibaojing", 45, 2, "极限低水位报警", 0, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_chushuiwenduchuanganqiduanlu", 45, 2, "出水温度传感器断路", 1));
            _this.addPoint(new meta_1.ExceptionField("ex_chushuiwenduchuanganqiduanlu", 45, 2, "出水温度传感器短路", 2, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_huishuiwenduchuanganqiduanlu", 45, 2, "回水温度传感器断路", 3));
            _this.addPoint(new meta_1.ExceptionField("ex_chushuiwendugaobaojing", 45, 2, "出水温度高报警", 4, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_paiyanwendugaobaojing", 45, 2, "排烟温度高报警", 5, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_chaoyabaojing", 45, 2, "超压报警", 6, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_ranshaoqiguzhang", 45, 2, "燃烧器故障", 7, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_ranqiyalidibaojing", 45, 2, "燃气压力低报警", 8, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_ranqixieloubaojing", 45, 2, "燃气泄漏报警", 9, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_dianjiedianyalibiaoduanlu", 45, 2, "电接点压力表短路", 11, meta_1.ExceptionField.Exception_Error));
            _this.addPoint(new meta_1.ExceptionField("ex_shuiweidianjiluojicuo", 45, 2, "水位电极逻辑错", 12));
            _this.addPoint(new meta_1.ExceptionField("ex_gaoshuiweibaojing", 45, 2, "高水位报警", 13, meta_1.ExceptionField.Exception_Error));

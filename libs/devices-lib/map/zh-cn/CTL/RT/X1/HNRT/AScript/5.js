...
var Map_CTL_RT_X1_HNRT_RYZQ_5 = /** @class */ (function (_super) {
    ...
    function Map_CTL_RT_X1_HNRT_RYZQ_5() {
        ...
        _this.addPoint(new CountShowField_1.CountShowField(comms_1.GroupKeys.KEY_BASE, 'ba_yalizhuangtai', '压力状态', '', false, Map_CTL_RT_X1_HNRT_RYZQ_5.DJD_YaLiStatus));
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_PaiYanWenDu, 13, 2, '排烟温度', '℃'));

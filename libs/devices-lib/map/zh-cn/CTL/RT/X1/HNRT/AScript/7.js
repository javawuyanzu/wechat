...
var Map_CTL_RT_X1_HNRT_DZQ_7 = /** @class */ (function (_super) {
    ...
    function Map_CTL_RT_X1_HNRT_DZQ_7() {
        ...
        _this.addPoint(new CountShowField_1.CountShowField(comms_1.GroupKeys.KEY_BASE, 'ba_yalizhuangtai', '压力状态', '', false, Map_CTL_RT_X1_HNRT_DZQ_7.DJD_YaLiStatus));
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 45, 2, '超压报警', 3, meta_1.ExceptionField.Exception_Error));

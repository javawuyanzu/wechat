...
var Map_CTL_RT_T2_RYRS_Ts = /** @class */ (function (_super) {
    ...
    function Map_CTL_RT_T2_RYRS_Ts() {
        ...
        _this.addPoint(new meta_1.ExceptionField("ex_chushuiwendugaobaojing_", 45, 2, "出水温度高报警", 2, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField("ex_huishuiwenduchuanganqiduanlu1", 45, 2, "回水温度传感器断路", 3));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_PaiYanWenDuChaoGao, 45, 2, "排烟温度高报警", 4, meta_1.ExceptionField.Exception_Error), "ex_paiyanwendugaobaojing");
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 45, 2, "极限低水位报警", 5, meta_1.ExceptionField.Exception_Error), "ex_jixiandishuiweibaojing");
        _this.addPoint(new meta_1.ExceptionField("ex_shuiweidianjiluojicuo", 45, 2, "水位电极逻辑错", 6));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianGaoShuiWei, 45, 2, "高水位报警", 7, meta_1.ExceptionField.Exception_Error), "ex_gaoshuiweibaojing");
        _this.addPoint(new meta_1.ExceptionField("ex_dianjiedianyalibiaoduanlu", 45, 2, "电接点压力表短路", 8, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 45, 2, "超压报警（控制器）", 9, meta_1.ExceptionField.Exception_Error), "ex_chaoyabaojing_kongzhiqi_");
        _this.addPoint(new meta_1.ExceptionField("ex_ranqiyalidibaojing", 45, 2, "燃气压力低报警", 10, meta_1.ExceptionField.Exception_Error));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_RanQiXieLou, 47, 2, "燃气泄漏报警", 11, meta_1.ExceptionField.Exception_Error), "ex_ranqixieloubaojing");
        _this.addPoint(new meta_1.ExceptionField("ex_ranshaoqiguzhang", 47, 2, "燃烧器故障", 12, meta_1.ExceptionField.Exception_Error));

...
var Map_CTL_RT_T2_RYRS_Ts = /** @class */ (function (_super) {
    ...
    function Map_CTL_RT_T2_RYRS_Ts() {
        ...
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_ChuKouWenDu, 13, 2, "Effluent temperature", "℃"), "mo_chushuiwendu");
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_HuiLiuWenDu, 15, 2, "Backwater temperature", "℃"), "mo_huishuiwendu");
        _this.addPoint(new meta_1.MockField(gfrm_1.GroupFieldsRelationalMapping.KEY_MOCK_PaiYanWenDu, 21, 2, "Discharged Flue Gas Temperature", "℃"), "mo_paiyanwendu");
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_PaiYanWenDuChaoGao, 45, 2, "High Discharged Flue Gas Temperature Alarm", 4), "ex_paiyanwendugaobaojing");
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianDiShuiWei, 45, 2, "Extreme Low Water Level Alarm", 5), "ex_jixiandishuiweibaojing");
        _this.addPoint(new meta_1.ExceptionField("ex_shuiweidianjiluojicuo", 45, 2, "Water-level Electrode Logic Error", 6));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_JiXianGaoShuiWei, 45, 2, "High Water Level Alarm", 7), "ex_gaoshuiweibaojing");
        ...
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_ChaoYa, 45, 2, "Overvoltage alarm (controller)", 9), "ex_chaoyabaojing_kongzhiqi_");
        _this.addPoint(new meta_1.ExceptionField("ex_ranqiyalidibaojing", 45, 2, "Low Gas Pressure Alarm", 10));
        _this.addPoint(new meta_1.ExceptionField(gfrm_1.GroupFieldsRelationalMapping.KEY_Expt_RanQiXieLou, 47, 2, "Gas Leakage Alarm", 11), "ex_ranqixieloubaojing");

...
exports.CRC16Util = void 0;
var NumberUtil_1 = require("./NumberUtil");
var CRC16Util = /** @class */ (function () {
    function CRC16Util() {
    }
    /**
     * 计算CRC16校验
     ...
     * @return CRC16校验值
     */
    CRC16Util.calcCrc16 = function (data, offset, len, preval) {
        if (preval === void 0) { preval = 0xffff; }
        var ucCRCHi = (preval & 0xff00) >> 8;
        var ucCRCLo = preval & 0x00ff;
        var iIndex;
        for (var i = 0; i < len; ++i) {
     ...
     * @return
     */
    CRC16Util.getCrc = function (res, bigEndian) {
        if (bigEndian === void 0) { bigEndian = false; }
        var str = NumberUtil_1.NumberUtil.NumberToString(res, 16, 4);
        if (bigEndian)
            return str;
        var substring = str.substring(0, 2);
        var substring1 = str.substring(2, 4);
